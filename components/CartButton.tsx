...
export function CartButton() {
  ...
  return (
    <>
      <div className="fixed bottom-24 md:bottom-32 right-5 z-40">
        <motion.button
          ...
          className="relative bg-amber-600 text-white p-3.5 md:p-4 rounded-full shadow-lg hover:shadow-xl transition-all"
