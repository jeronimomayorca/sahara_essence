...
export default function AboutSection() {
  ...
  return (
    <section
      id="sobre-nosotros"
      ref={containerRef}
      className="relative py-16 md:py-24 px-4 overflow-hidden scroll-mt-24 bg-background"
    >
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <h2
          ref={titleRef}
          className="font-cormorant font-medium text-3xl md:text-6xl mb-10 md:mb-16 text-center text-amber-600 dark:text-amber-400"
        >
          Sobre Nosotros
        </h2>
        ...
        <div className="space-y-12 md:space-y-16">
          ...
          >
            <div className="relative p-6 md:p-8 rounded-2xl bg-card/40 backdrop-blur-sm border border-amber-200/40 dark:border-amber-800/20 shadow-sm transition-all duration-500 hover:shadow-xl hover:shadow-amber-500/5 hover:border-amber-300/50">
          ...
          >
            <div className="relative p-6 md:p-8 rounded-2xl bg-card/40 backdrop-blur-sm border border-orange-200/40 dark:border-orange-800/20 shadow-sm transition-all duration-500 hover:shadow-xl hover:shadow-orange-500/5 hover:border-orange-300/50">
              <p className="font-inter text-base md:text-lg text-foreground/90 leading-relaxed">
